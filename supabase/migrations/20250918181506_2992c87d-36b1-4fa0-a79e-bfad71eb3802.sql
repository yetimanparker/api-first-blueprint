...
ADD CONSTRAINT fk_product_pricing_tiers_product_id 
FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE;

-- Create unique constraints
CREATE UNIQUE INDEX idx_product_pricing_tiers_min_quantity 
ON public.product_pricing_tiers (product_id, min_quantity);

CREATE UNIQUE INDEX idx_product_pricing_tiers_max_quantity 
ON public.product_pricing_tiers (product_id, max_quantity) 
