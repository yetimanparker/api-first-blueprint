-- Update handle_new_user function to include 3 measurement tools
...
BEGIN
  ...
  IF NEW.raw_user_meta_data ->> 'business_name' IS NOT NULL THEN
    ...
    VALUES (
      ...
      true,
      4,
      'https://aiwwquousyzdkagporcy.supabase.co/storage/v1/object/public/product-photos/defaults/linear-tool.png'
    )
    ...
    VALUES (
      ...
      true,
      5,
      'https://aiwwquousyzdkagporcy.supabase.co/storage/v1/object/public/product-photos/defaults/square-tool.png'
    )
    ...
    VALUES (
      ...
      true,
      6,
      'https://aiwwquousyzdkagporcy.supabase.co/storage/v1/object/public/product-photos/defaults/cubic-tool.png'
    )
